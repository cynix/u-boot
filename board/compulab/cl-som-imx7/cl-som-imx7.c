...
/*
 * cl_som_imx7_setup_i2c0() - I2C0 pinmux configuration.
 */
...
static int cl_som_imx7_eth_init_pri(bd_t *bis)
{
	...
	return fecmxc_initialize_multi_mii(bis, CL_SOM_IMX7_FEC_DEV_ID_PRI,
				       CL_SOM_IMX7_FEC_PHYADDR_PRI,
				       IMX_FEC_BASE, IMX_FEC_BASE);
}

/*
 * cl_som_imx7_eth_init_sec() - secondary Ethernet interface initialization
 *
 * @bis: board information
 *
 * @return: 0 on success, < 0 on failure
...
static int cl_som_imx7_eth_init_sec(bd_t *bis)
{
	...
	return fecmxc_initialize_multi_mii(bis, CL_SOM_IMX7_FEC_DEV_ID_SEC,
